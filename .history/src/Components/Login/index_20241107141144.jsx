...
const LoginHeader = () => (
  <div className="text-center mb-4">
    ...
    <p className="text-muted subtitle">Solução Integrada para Imobiliárias</p>
  </div>
);

// Componente do checkbox "Lembrar Senha"
const CheckboxRemember = ({ rememberPassword, setRememberPassword }) => (
